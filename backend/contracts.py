...
Frontend types: frontend/src/contracts.gen.ts — GENERATED by
scripts/generate_contracts_ts.py; edit this file, run the generator, never
edit the .gen.ts (freshness enforced by --check in smoke.sh and tests).
